      ...
      <div className="bg-slate-100  w-screen antialiased text-slate-300 selection:bg-blue-600 selection:text-white z-10 ">
        <div className="flex flex-col relative w-screen">
          ...
          >
            <div
              id="logo"
              className="my-4 px-6 sr-only sm:not-sr-only sm:px-6 sm:my-4"
            >
            ...
            <div id="profile" className="px-6 pt-5 sm:py-5 border ">
            ...
            <div className="w-full px-6 grid grid-cols-3 gap-2 sm:grid-cols-1 ">
